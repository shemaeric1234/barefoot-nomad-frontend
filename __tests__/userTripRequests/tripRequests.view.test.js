...
import { Requests, mapStateToProps, handleClick } from '../../src/views/trip_requests/userTripRequests.view.jsx';
...
describe('Trip request test', () => {
    it('should render trip request ui successfully', () => {
        ...
        const wrapper = createMount()(<MuiThemeProvider theme={theme}>
            <Requests trips={props} history={{ push: jest.fn() }} getUserTripRequestsAction={jest.fn()} setSelectedTripRequestAction={jest.fn()} />
        </MuiThemeProvider>);
        ...
        const wrapper1 = createMount()(<MuiThemeProvider theme={theme1}>
            <Requests trips={props} history={{ push: jest.fn() }} getUserTripRequestsAction={jest.fn()} setSelectedTripRequestAction={jest.fn()} />
        </MuiThemeProvider>);
