...
describe('User trip requests reducer tests', () => {
    it('shoult get all trip requests', () => {
        const result = tripRequestReducers({ myTrips: [], trip: {} }, {
            type: "GET_USER_TRIP_REQUESTS_SUCCESS", payload: [{
                "id": 1,
                "origin": "Kigali",
                "destination": "Kincasa",
    ...
    it('shoult set selected trip request', () => {
        const result = tripRequestReducers({ myTrips: [], trip: {} }, {
            type: "SET_SELLECTED_TRIP", payload: {
                "id": 1,
                "origin": "Kigali",
                "destination": "Kincasa",
                "tripId": "b4c99c41-9d2a-42f1-9a4c-65111d48e0d4",
    ...
    it('shoult return default value', () => {
        const result = tripRequestReducers({ myTrips: [], trip: {} }, {
            type: "SET_SELLECTED_TRIPR", payload: {
                "id": 1,
                "origin": "Kigali",
                "destination": "Kincasa",
                "tripId": "b4c99c41-9d2a-42f1-9a4c-65111d48e0d4",
