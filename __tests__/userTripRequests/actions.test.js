...
import { getUserTripRequestsAction, setSelectedTripRequestAction } from '../../src/actions/requests/tripRequestsAction';
...
describe('Trip requests actions tests', () => {
    ...
    it('should get all user trip requests', async () => {
        ...
        await store.dispatch(getUserTripRequestsAction({}))
            .then(async () => {
    ...
    it('should set selected trip request', async () => {
        await store.dispatch(setSelectedTripRequestAction({
            "id": 1,
            "origin": "Kigali",
            "destination": "Kincasa",
            "tripId": "b4c99c41-9d2a-42f1-9a4c-65111d48e0d4",
