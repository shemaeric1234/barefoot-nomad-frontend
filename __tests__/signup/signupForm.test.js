...
describe('Render signup form view', () => {
    ...
    it('should render signup form view successfully', async () => {
        ...
        emailTxt.props().onChange({ target: { value: 'nsengimanaveda@gmail.com' } });
        ...
        confirm_passwordTxt2.props().onChange({ target: { value: '1234567890ou' } });
