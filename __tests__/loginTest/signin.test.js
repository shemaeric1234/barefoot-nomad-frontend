...
import { LoginForm , mapStateToProps} from '../../src/components/auth/Login.jsx';
...
describe('Render signIn component', () => {
    it('should call action on form submit', () => {
        ...
        const submitRequest = sinon.stub(wrapper.instance(), 'handleSubmit').returns(true);
    ...
    it('should handle change successfully', () => {
        ...
        component.find('[data-test="signin-email"]').simulate('change',{target: { name: 'email', value: 'jajabenit@gmail.com'}}); 
        component.find('[data-test="signin-password"]').simulate('change',{target: { name: 'password', value: '0727570939'}}); 
